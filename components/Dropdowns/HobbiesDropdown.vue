<template>
    <DropDownComponent title="Hobbies" icon="mdi-face-man-shimmer-outline">
      <v-list>
        ...
        <v-list-item prepend-icon="mdi-earth" title="Traveling">I absolutely love traveling and I've been very fortunate to be able to do it a lot. As a Spanish citizen, I have been able to visit many countries in Europe such as Spain, England, France, Germany, Belgium, Russia, and more. I have also been to the Carribbean such as Cuba, Bahamas, Dominican Republic, and more. Traveling is something I hope I can continue to do as I get older.</v-list-item>
